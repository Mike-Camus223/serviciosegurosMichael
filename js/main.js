document.addEventListener("DOMContentLoaded", () => {
    ...
    btnCotizar.addEventListener("click", e => {
        ...
        contenedor.innerHTML =
            `<div id="miniModal" 
  class="opacity-0 scale-95 transition-all duration-500 ease-out 
         bg-white text-gray-900 border border-gray-300 shadow-lg 
         rounded-lg p-6 mt-4 w-full max-w-lg mx-auto">
  <h2 class="text-2xl font-bold text-gray-800 mb-2">Cotización Realizada</h2>
  <p><b>Marca:</b> ${marca}</p>
  ...
  <p><b>Costo del seguro mensual:</b> 
    <span class="text-green-600 font-bold">
      $${Math.round(costoSeguro).toLocaleString("es-AR")}
    </span>
  </p>
